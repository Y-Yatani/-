###D‘Esopo-Lefkowitzモデルの走塁規則を応用した理論期待得点と理論得点確率の導出
...
for(i in 1:9){
  BattingProbability[i, 1] <- rnorm(1, mean = 0.177175891, sd = 0.05)
  BattingProbability[i, 2] <- rnorm(1, mean = 0.025050851, sd = 0.01)
  BattingProbability[i, 3] <- rnorm(1, mean = 0.005138636, sd = 0.0025)
  BattingProbability[i, 4] <- rnorm(1, mean = 0.004496307, sd = 0.002)
  BattingProbability[i, 5] <- rnorm(1, mean = 0.113371159, sd = 0.03)
  for(j in 1:5){
...
for(k in 1:9){
  for(l in 1:3){
    b[((k - 1) * 24) + ((l - 1) * 8) + 1] <- BattingProbability[k, 4]
    b[((k - 1) * 24) + ((l - 1) * 8) + 2] <- BattingProbability[k, 3] + BattingProbability[k, 4]
    b[((k - 1) * 24) + ((l - 1) * 8) + 3] <- p * BattingProbability[k, 1] + BattingProbability[k, 2] + BattingProbability[k, 3] + BattingProbability[k, 4]
    b[((k - 1) * 24) + ((l - 1) * 8) + 4] <- BattingProbability[k, 1] + BattingProbability[k, 2] + BattingProbability[k, 3] + BattingProbability[k, 4]
    b[((k - 1) * 24) + ((l - 1) * 8) + 5] <- p * BattingProbability[k, 1] + BattingProbability[k, 2] + BattingProbability[k, 3] + BattingProbability[k, 4]
    b[((k - 1) * 24) + ((l - 1) * 8) + 6] <- BattingProbability[k, 1] + BattingProbability[k, 2] + BattingProbability[k, 3] + BattingProbability[k, 4]
    b[((k - 1) * 24) + ((l - 1) * 8) + 7] <- BattingProbability[k, 1] + BattingProbability[k, 2] + BattingProbability[k, 3] + BattingProbability[k, 4]
    b[((k - 1) * 24) + ((l - 1) * 8) + 8] <- BattingProbability[k, 1] + BattingProbability[k, 2] + BattingProbability[k, 3] + BattingProbability[k, 4] + BattingProbability[k, 5]
  }
}
#係数行列Aの設定
A = matrix(0, 216, 216)
